...
public class mxMarkerRegistry {
    ...
    static {
        ...
        registerMarker(mxConstants.ARROW_OPEN, (mxGraphics2DCanvas canvas, mxCellState state, String type, mxPoint pe, double nx, double ny, double size, boolean source) -> {
        ...
        registerMarker(mxConstants.ARROW_OVAL, (mxGraphics2DCanvas canvas, mxCellState state, String type, mxPoint pe, double nx, double ny, double size, boolean source) -> {
        ...
        registerMarker(mxConstants.ARROW_DIAMOND, (mxGraphics2DCanvas canvas, mxCellState state, String type, mxPoint pe, double nx, double ny, double size, boolean source) -> {
            Polygon poly = new Polygon();
            poly.addPoint((int) Math.round(pe.getX()),
                    (int) Math.round(pe.getY()));
