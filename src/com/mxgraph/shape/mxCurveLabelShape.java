...
public class mxCurveLabelShape implements mxITextShape {
    ...
    public void paintShape(mxGraphics2DCanvas canvas, String text,
        ...
        if (labelGlyphs != null
            ...
            for (LabelGlyphCache labelGlyph : labelGlyphs) {
                mxLine parallel = labelGlyph.glyphGeometry;
                if (labelGlyph.visible && parallel != null && parallel != mxCurve.INVALID_POSITION) {
    ...
    public mxRectangle updateLabelBounds(String label, Map<String, Object> style) {
        ...
        if (!label.equals(lastValue) || !font.equals(lastFont)) {
            ...
            ArrayList<LabelGlyphCache> glyphList = new ArrayList<>();
    ...
    public boolean intersectsRect(Rectangle rect) {
        ...
        for (LabelGlyphCache labelGlyph : labelGlyphs) {
            if (labelGlyph.visible && rect.intersects(labelGlyph.drawingBounds.getRectangle())) {
                return true;
            }
        }
