...
public class mxHtmlTextShape implements mxITextShape {
    ...
    protected String createHtmlDocument(Map<String, Object> style, String text,
        ...
        return switch (overflow) {
            case "fill" -> mxUtils.createHtmlDocument(style, text, 1, w, null, "height:" + h + "pt;");
            case "width" -> mxUtils.createHtmlDocument(style, text, 1, w);
            default -> mxUtils.createHtmlDocument(style, text);
        };
    }
