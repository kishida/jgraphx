...
public class mxMinimumCycleRemover implements mxHierarchicalLayoutStage {
    ...
    public void execute(Object parent) {
        ...
        final Set<mxGraphHierarchyNode> seenNodes = new HashSet<>();
        final Set<mxGraphHierarchyNode> unseenNodes = new HashSet<>(
        ...
        model.visit((mxGraphHierarchyNode parent1, mxGraphHierarchyNode cell, mxGraphHierarchyEdge connectingEdge, int layer, int seen) -> {
        ...
        Set<mxGraphHierarchyNode> seenNodesCopy = new HashSet<>(
                seenNodes);
