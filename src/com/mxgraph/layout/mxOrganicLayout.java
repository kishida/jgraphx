...
public class mxOrganicLayout extends mxGraphLayout {
    ...
    public void execute(Object parent) {
        ...
        HashSet<Object> vertexSet = new HashSet<>(Arrays.asList(vertices));

        HashSet<Object> validEdges = new HashSet<>();

        // Remove edges that do not have both source and target terminals visible
        for (Object vertice : vertices) {
            Object[] edges = mxGraphModel.getEdges(model, vertice, false, true, false);
            for (Object edge : edges) {
                ...
                // each edge twice.
                if (view.getVisibleTerminal(edge, true) == vertice && vertexSet.contains(view.getVisibleTerminal(edge, false))) {
                    validEdges.add(edge);
                }
            }
        }
     ...
     * @param oldNodeDistribution The previous node distribution energy cost of
     * this node
     * @param oldEdgeDistance The previous edge distance energy cost of this
     * node
     * @param oldEdgeCrossing The previous edge crossing energy cost for edges
     * connected to this node
     * @param oldBorderLine The previous border line energy cost for this node
     * @param oldEdgeLength The previous edge length energy cost for edges
     * connected to this node
     * @param oldAdditionalFactorsEnergy The previous energy cost for additional
     * factors from sub-classes
     *
    ...
    protected int[] getRelevantEdges(int cellIndex) {
        ArrayList<Integer> relevantEdgeList = new ArrayList<>(e.length);
    ...
    protected int[] getConnectedEdges(int cellIndex) {
        ArrayList<Integer> connectedEdgeList = new ArrayList<>(e.length);
    ...
    /**
     * @param unchangedEnergyRoundTermination The
     * unchangedEnergyRoundTermination to set.
     */
