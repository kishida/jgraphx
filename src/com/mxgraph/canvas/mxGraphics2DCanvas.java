    ...
    public Paint createFillPaint(mxRectangle bounds, Map<String, Object> style) {
        ...
        if (fillColor != null) {
            ...
            if (gradientColor != null) {
                ...
                } else switch (gradientDirection) {
                    case mxConstants.DIRECTION_SOUTH -> y2 = (float) (bounds.getY() + bounds.getHeight());
                    case mxConstants.DIRECTION_EAST -> x2 = (float) (bounds.getX() + bounds.getWidth());
                    case mxConstants.DIRECTION_NORTH -> y1 = (float) (bounds.getY() + bounds.getHeight());
                    case mxConstants.DIRECTION_WEST -> x1 = (float) (bounds.getX() + bounds.getWidth());
                    default -> {
                    }
                }
