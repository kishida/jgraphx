...
public class mxSvgCanvas extends mxBasicCanvas {
    ...
    protected Element createGradientElement(String start, String end,
        ...
        if (null == direction) {
            ...
            case mxConstants.DIRECTION_SOUTH -> gradient.setAttribute("y2", "100%");
            case mxConstants.DIRECTION_EAST -> gradient.setAttribute("x2", "100%");
            case mxConstants.DIRECTION_NORTH -> gradient.setAttribute("y1", "100%");
            case mxConstants.DIRECTION_WEST -> gradient.setAttribute("x1", "100%");
            default -> {
            }
        }
    ...
    public String getGradientId(String start, String end, String direction) {
        ...
        if (null == direction) {
            ...
            case mxConstants.DIRECTION_SOUTH -> dir = "south";
            case mxConstants.DIRECTION_EAST -> dir = "east";
            default -> {
                String tmp = start;
                start = end;
                end = tmp;
    ...
    public Element drawShape(int x, int y, int w, int h,
        ...
        switch (shape) {
            ...
            case mxConstants.SHAPE_TRIANGLE ->                 {
                    ...
                    String d = null;
                    d = switch (direction) {
                case mxConstants.DIRECTION_NORTH -> "M " + x + " " + (y + h) + " L " + (x + w / 2) + " " + y
                            + " L " + (x + w) + " " + (y + h);
                case mxConstants.DIRECTION_SOUTH -> "M " + x + " " + y + " L " + (x + w / 2) + " " + (y + h)
                            + " L " + (x + w) + " " + y;
                case mxConstants.DIRECTION_WEST -> "M " + (x + w) + " " + y + " L " + x + " " + (y + h / 2)
                            + " L " + (x + w) + " " + (y + h);
                default -> "M " + x + " " + y + " L " + (x + w) + " " + (y + h / 2)
                            + " L " + x + " " + (y + h);
            }; // east
                    elem.setAttribute("d", d + " Z");
                }
                ...
                if (shape.equals(mxConstants.SHAPE_LABEL)) {
                    ...
                    if (img != null) {
                        ...
                        switch (imgAlign) {
                            ...
                            case mxConstants.ALIGN_RIGHT -> imageBounds.setX(imageBounds.getX()
                        ...
                        switch (imgValign) {
                            ...
                            case mxConstants.ALIGN_BOTTOM -> imageBounds
    ...
    public Object drawText(String text, int x, int y, int w, int h,
        ...
        if (text != null && text.length() > 0) {
            ...
            switch (align) {
                ...
                default -> x += mxConstants.LABEL_INSET * scale;
            }
