...
public class mxVmlCanvas extends mxBasicCanvas {
    ...
    public Element drawShape(int x, int y, int w, int h,
        ...
        switch (shape) {
            ...
            case mxConstants.SHAPE_ELLIPSE -> elem = document.createElement("v:oval");
            ...
            case mxConstants.SHAPE_TRIANGLE ->                 {
                    ...
                    case mxConstants.DIRECTION_NORTH -> "m 0 " + h + " l " + (w / 2) + " 0 " + " l " + w + " "
                            + h;
                    case mxConstants.DIRECTION_SOUTH -> "m 0 0 l " + (w / 2) + " " + h + " l " + w + " 0";
                    case mxConstants.DIRECTION_WEST -> "m " + w + " 0 l " + w + " " + (h / 2) + " l " + w
                            + " " + h;
                    default -> "m 0 0 l " + w + " " + (h / 2) + " l 0 " + h;
                }; // east
                    elem.setAttribute("path", points + " x e");
                }
