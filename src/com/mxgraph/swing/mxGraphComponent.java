...
public class mxGraphComponent extends JScrollPane implements Printable {
     ...
     */
    protected Map<Object, mxICellOverlay[]> overlays = new HashMap<>();
     ...
     * @param parent
     * <mxCell> that should be used as the root of the recursion. Default is
     * <defaultParent>.
    ...
    public Object[] getImportableCells(Object[] cells) {
        return mxGraphModel.filterCells(cells, this::canImportCell);
    }
    ...
    public Object[] getExportableCells(Object[] cells) {
        return mxGraphModel.filterCells(cells, this::canExportCell);
    }
    ...
    public void updateComponents() {
        ...
        Map<Object, Component[]> result = updateComponents(root);
        ...
        if (!overlays.isEmpty()) {
            Map<Object, mxICellOverlay[]> result2 = updateCellOverlays(root);
     ...
     *
     */
    public void removeAllComponents(Map<Object, Component[]> map) {
        for (Map.Entry<Object, Component[]> entry : map.entrySet()) {
            Component[] c = entry.getValue();

            for (Component c1 : c) {
                removeComponent(c1, entry.getKey());
            }
        }
    }
     ...
     *
     */
    public void removeAllOverlays(Map<Object, mxICellOverlay[]> map) {
        for (Map.Entry<Object, mxICellOverlay[]> entry : map.entrySet()) {
            mxICellOverlay[] c = entry.getValue();

            for (mxICellOverlay c1 : c) {
                removeCellOverlayComponent(c1, entry.getKey());
            }
        }
    }
     ...
     *
     */
    public Map<Object, Component[]> updateComponents(Object cell) {
        Map<Object, Component[]> result = new HashMap<>();
     ...
     */
    public String validateGraph(Object cell, Map<Object, Object> context) {
        mxIGraphModel model = graph.getModel();
        mxGraphView view = graph.getView();
    ...
    public mxICellOverlay removeCellOverlay(Object cell, mxICellOverlay overlay) {
        if (overlay == null) {
            ...
            if (arr != null) {
                ...
                List<mxICellOverlay> list = new ArrayList<>(
                        Arrays.asList(arr));
                ...
                arr = list.toArray(mxICellOverlay[]::new);
                overlays.put(cell, arr);
            }
        }
     ...
     * kept in the result.
     */
    public Map<Object, mxICellOverlay[]> updateCellOverlays(Object cell) {
        Map<Object, mxICellOverlay[]> result = new HashMap<>();
        ...
        if (c != null) {
            if (state != null) {
                for (mxICellOverlay c1 : c) {
                    updateCellOverlayComponent(state, c1);
                }
            } else {
                for (mxICellOverlay c1 : c) {
                    removeCellOverlayComponent(c1, cell);
                }
            }
    ...
    public class mxGraphControl extends JComponent {
        ...
        /**
         * @param state the cached state of the cell whose extended bounds are
         * to be calculated
