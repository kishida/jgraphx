...
public class mxGraphTransferable implements Transferable, UIResource,
    ...
    /**
     * Global switch to disable image support in transferables. Set this to
     * false as a workaround for Data translation failed: not an image format in
    ...
    public boolean isDataFlavorSupported(DataFlavor flavor) {
        ...
        for (DataFlavor flavor1 : flavors) {
            if (flavor1 != null && flavor1.equals(flavor)) {
                return true;
            }
        }
