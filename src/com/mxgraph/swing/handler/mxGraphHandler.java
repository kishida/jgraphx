...
public class mxGraphHandler extends mxMouseAdapter implements
    ...
    public mxGraphHandler(final mxGraphComponent graphComponent) {
        ...
        graphComponent.addListener(mxEvent.AFTER_PAINT, (Object sender, mxEventObject evt) -> {
        ...
        DragGestureListener dragGestureListener = (DragGestureEvent e) -> {
            if (graphComponent.isDragEnabled() && first != null) {
                final TransferHandler th = graphComponent
                        .getTransferHandler();
                if (th instanceof mxGraphTransferHandler graphTransferHandler) {
                    final mxGraphTransferable t = (mxGraphTransferable) graphTransferHandler.createTransferable(graphComponent);
                    if (t != null) {
                        e.startDrag(null, mxSwingConstants.EMPTY_IMAGE, new Point(), t, new DragSourceAdapter() {
                            ...
                            public void dragDropEnd(DragSourceDropEvent dsde) {
                                graphTransferHandler.exportDone(graphComponent, t, TransferHandler.NONE);
                                first = null;
                            }
                        });
                    }
    ...
    protected MouseEvent createEvent(DropTargetEvent e) {
        ...
        if (e instanceof DropTargetDropEvent dropTargetDropEvent) {
            location = dropTargetDropEvent.getLocation();
            action = dropTargetDropEvent.getDropAction();
        } else if (e instanceof DropTargetDragEvent dropTargetDragEvent) {
            location = dropTargetDragEvent.getLocation();
            action = dropTargetDragEvent.getDropAction();
        }
    ...
    protected static final mxGraphTransferHandler getGraphTransferHandler(
        ...
        if (transferHandler instanceof mxGraphTransferHandler graphTransferHandler) {
            return graphTransferHandler;
        }
