...
public class mxCellEditor implements mxICellEditor {
    ...
    class NoLinefeedHtmlEditorKit extends HTMLEditorKit {
        ...
        public void write(Writer out, Document doc, int pos, int len)
            ...
            if (doc instanceof HTMLDocument hTMLDocument) {
                NoLinefeedHtmlWriter w = new NoLinefeedHtmlWriter(out, hTMLDocument, pos, len);
                ...
                w.write();
            } else if (doc instanceof StyledDocument styledDocument) {
                MinimalHTMLWriter w = new MinimalHTMLWriter(out, styledDocument, pos, len);
                w.write();
            } else {
