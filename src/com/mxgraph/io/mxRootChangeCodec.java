...
public class mxRootChangeCodec extends mxObjectCodec {
    ...
    public Node afterEncode(mxCodec enc, Object obj, Node node) {
        if (obj instanceof mxRootChange rootChange) {
            enc.encodeCell((mxICell) rootChange.getRoot(), node, true);
        }
    ...
    public Node beforeDecode(mxCodec dec, Node node, Object into) {
        if (into instanceof mxRootChange change) {
    ...
    public Object afterDecode(mxCodec dec, Node node, Object obj) {
        if (obj instanceof mxRootChange change) {
