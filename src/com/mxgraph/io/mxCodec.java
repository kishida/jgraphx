...
public class mxCodec {
     ...
     *
     * @param document Optional XML document that contains the data. If no
     * document is specified then a new document is created using
    ...
    public Node encode(Object obj) {
        ...
        if (obj != null) {
            ...
            if (enc != null) {
                ...
                if (obj instanceof Node node1) {
                    node = node1.cloneNode(true);
                } else {
     ...
     * @param includeChildren Boolean indicating if the method should include
     * all descendents.
     */
     ...
     * @param restoreStructures Boolean indicating whether the graph structure
     * should be restored by calling insert and insertEdge on the parent and
