...
public class mxUtils {
     ...
     *
     * @param terminal the cached cell state of the cell to determine the port
     * constraints for
    ...
    public static Collection<Object> sortCells(Collection<Object> cells,
        ...
        SortedSet<Object> result = new TreeSet<>((Object o1, Object o2) -> {
     ...
     *
     * @deprecated Use
     * <code>mxStyleUtils.indexOfStylename(String, String)</code> (Jan 2012)
     */
     ...
     * @deprecated Use
     * <code>mxStyleUtils.setStyle(String, String, String)</code> (Jan 2012)
     */
     ...
     * @deprecated Use
     * <code>mxStyleUtils.setStyleFlag(String, String, int, Boolean)</code> (Jan
     * 2012)
     */
     ...
     * @return float[]
     * @exception NumberFormatException if any of the dash widths cannot be
