...
public class mxPerimeter {
    ...
    public interface mxPerimeterFunction {
         ...
         * given edge.
         * @param orthogonal Boolean that specifies if the orthogonal projection
         * onto the perimeter should be returned. If this is false then the
         * intersection of the perimeter and the line between the next and the
         * center point is returned.
     ...
     */
    public static mxPerimeterFunction RectanglePerimeter = (mxRectangle bounds, mxCellState vertex, mxPoint next, boolean orthogonal) -> {
     ...
     */
    public static mxPerimeterFunction EllipsePerimeter = (mxRectangle bounds, mxCellState vertex, mxPoint next, boolean orthogonal) -> {
     ...
     */
    public static mxPerimeterFunction RhombusPerimeter = (mxRectangle bounds, mxCellState vertex, mxPoint next, boolean orthogonal) -> {
        double x = bounds.getX();
        double y = bounds.getY();
     ...
     * of the parameters.
     */
    public static mxPerimeterFunction TrianglePerimeter = (mxRectangle bounds, mxCellState vertex, mxPoint next, boolean orthogonal) -> {
     ...
     * of the parameters.
     */
    public static mxPerimeterFunction HexagonPerimeter = (mxRectangle bounds, mxCellState vertex, mxPoint next, boolean orthogonal) -> {
        double x = bounds.getX();
        double y = bounds.getY();
        double w = bounds.getWidth();
        double h = bounds.getHeight();
