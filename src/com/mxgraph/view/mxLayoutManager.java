...
public class mxLayoutManager extends mxEventSource {
     ...
     *
     */
    protected mxIEventListener undoHandler = (Object source, mxEventObject evt) -> {
        if (isEnabled()) {
     ...
     *
     */
    protected mxIEventListener moveHandler = (Object source, mxEventObject evt) -> {
        if (isEnabled()) {
    ...
    protected void cellsMoved(Object[] cells, Point location) {
        if (cells != null && location != null) {
            ...
            for (Object cell : cells) {
                mxIGraphLayout layout = getLayout(model.getParent(cell));
                if (layout != null) {
    ...
    protected Collection<Object> getCellsForChange(mxUndoableChange change) {
        ...
        if (change instanceof mxChildChange cc) {
