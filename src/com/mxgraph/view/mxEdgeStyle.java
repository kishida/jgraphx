...
public class mxEdgeStyle {
     ...
     * diagrams).
     */
    public static mxEdgeStyleFunction EntityRelation = (mxCellState state, mxCellState source, mxCellState target, List<mxPoint> points, List<mxPoint> result) -> {
     ...
     */
    public static mxEdgeStyleFunction Loop = (mxCellState state, mxCellState source, mxCellState target, List<mxPoint> points, List<mxPoint> result) -> {
        if (source != null) {
            mxGraphView view = state.getView();
            ...
            if (pt == null || pt.getX() < source.getX()
                ...
                if (pt != null) {
                    ...
                    switch (dir) {
                        case mxConstants.DIRECTION_NORTH -> y = source.getY() - 2 * dx;
                        case mxConstants.DIRECTION_SOUTH -> y = source.getY() + source.getHeight() + 2 * dx;
                        case mxConstants.DIRECTION_EAST -> x = source.getX() - 2 * dy;
     ...
     */
    public static mxEdgeStyleFunction ElbowConnector = (mxCellState state, mxCellState source, mxCellState target, List<mxPoint> points, List<mxPoint> result) -> {
     ...
     */
    public static mxEdgeStyleFunction SideToSide = (mxCellState state, mxCellState source, mxCellState target, List<mxPoint> points, List<mxPoint> result) -> {
        mxGraphView view = state.getView();
        mxPoint pt = ((points != null && points.size() > 0) ? points.get(0)
                : null);
        mxPoint p0 = state.getAbsolutePoint(0);
     ...
     */
    public static mxEdgeStyleFunction TopToBottom = (mxCellState state, mxCellState source, mxCellState target, List<mxPoint> points, List<mxPoint> result) -> {
        mxGraphView view = state.getView();
        mxPoint pt = ((points != null && points.size() > 0) ? points.get(0)
                : null);
        mxPoint p0 = state.getAbsolutePoint(0);
     ...
     */
    public static mxEdgeStyleFunction SegmentConnector = (mxCellState state, mxCellState source, mxCellState target, List<mxPoint> hints, List<mxPoint> result) -> {
